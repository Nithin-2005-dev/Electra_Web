...
const Semesters = () => {
  ...
  return (
    ...
    >
      <motion.div className='text-5xl font-bold m-2 border-b-4 inline-block border-yellow-400 ' initial={{y:-10,opacity:0}} whileInView={{y:0,opacity:1,transition:{duration:2}}}>Semesters</motion.div>
