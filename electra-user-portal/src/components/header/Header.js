...
const Header = () => {
  ...
  return (
    ...
    <Link href={'/'}>
    <img src='https://res.cloudinary.com/dqa3ov76r/image/upload/v1729535834/favoritePhotos/ldlchr4ijcpgfq8nu2gx.jpg' alt='electra-logo' width={'55'} className='rounded-full'/>
    </Link>
    </div>
