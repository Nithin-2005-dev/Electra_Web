...
const CoreTeamFilter = () => {
  ...
  return (
    <div className='m-3 relative top-[5vh]'>
      ...
      <div className='flex justify-end my-2'>
        <select name="" id="" className='bg-blue-400 rounded-xl hover:opacity-80 lg:p-2 lg:px-3 md:p-3 md:px-3 sm:p-3 sm:px-3 p-0.5 px-0.5 m-2 font-bold text-sm' ref={yearRef} onChange={handleFilter}>
