...
const AboutUs = () => {
  return (
    <section id='about'>
      <motion.h2 className='text-5xl font-bold m-2 border-b-4 inline-block border-yellow-400 mx-4' initial={{y:-10,opacity:0}} whileInView={{y:0,opacity:1,transition:{duration:2}}}>About Us</motion.h2>
