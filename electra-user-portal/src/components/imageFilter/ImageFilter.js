  ...
  return <>
    {
      ...
      <select name="" id="" className='bg-slate-600 rounded-xl hover:opacity-80 lg:p-2 lg:px-3 md:p-2 md:px-3 sm:p-3 sm:px-3 p-1 px-1 text-xs lg:text-lg font-bold z-[3000]' onChange={(e)=>{
