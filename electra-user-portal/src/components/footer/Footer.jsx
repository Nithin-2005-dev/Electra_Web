...
const Footer = () => {
  return (
    ...
    <div className='flex justify-between items-center m-3'>
      ...
      <div>
        <img src='https://res.cloudinary.com/dqa3ov76r/image/upload/v1729535469/favoritePhotos/rdemjabrfg8mxrlb2nfo.jpg' alt='electra-logo' width={'150'} className='scale-[0.6] sm:scale-100'/>
        </div>
